// lib/game/boards/boardDefinitions.js
// CommonJS version for server.js
const { LEGACY_COURSES } = require('./legacyBoards.js');
const { DOCKING_BAY_BOARDS } = require('./dockingBayBoards.js');
const { Direction, TileType } = require('../types/enums.js');
// Import and merge legacy courses
// All courses

// Beginner Course Definitions
const RISKY_EXCHANGE = {
    id: 'risky_exchange',
    name: 'Risky Exchange',
...
const ALL_COURSES = [...COURSES, ...LEGACY_COURSES];
