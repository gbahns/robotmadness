...
// Cross Board Definition from official RoboRally
...
export const CROSS_BOARD: BoardDefinition = {
    ...
    tiles: [
        // Row 0 (top row) - going left to right
        ...
        // Row 1
        { position: { x: 1, y: 1 }, type: TileType.CONVEYOR, direction: Direction.DOWN, rotate: 'clockwise' }, // Curved conveyor
        ...
        { position: { x: 5, y: 1 }, type: TileType.CONVEYOR, direction: Direction.DOWN, rotate: 'counterclockwise' }, // Curved
        { position: { x: 6, y: 1 }, type: TileType.CONVEYOR, direction: Direction.UP },
        { position: { x: 9, y: 1 }, type: TileType.PIT },
        { position: { x: 10, y: 1 }, type: TileType.CONVEYOR, direction: Direction.UP, rotate: 'clockwise' }, // Curved
        ...
        { position: { x: 6, y: 4 }, type: TileType.CONVEYOR, direction: Direction.UP, rotate: 'counterclockwise' }, // Curved
        { position: { x: 7, y: 4 }, type: TileType.CONVEYOR, direction: Direction.LEFT, rotate: 'counterclockwise' }, // Curved
        ...
        { position: { x: 5, y: 5 }, type: TileType.CONVEYOR, direction: Direction.LEFT, rotate: 'clockwise' }, // Curved turning down
        { position: { x: 6, y: 5 }, type: TileType.PIT },
        { position: { x: 7, y: 5 }, type: TileType.CONVEYOR, direction: Direction.LEFT, rotate: 'counterclockwise' }, // Curved
        ...
        { position: { x: 4, y: 6 }, type: TileType.CONVEYOR, direction: Direction.RIGHT, rotate: 'counterclockwise' }, // Curved turning down
        { position: { x: 5, y: 6 }, type: TileType.PIT },
        { position: { x: 6, y: 6 }, type: TileType.CONVEYOR, direction: Direction.RIGHT, rotate: 'clockwise' }, // Curved turning up
        ...
        // Row 7
        { position: { x: 4, y: 7 }, type: TileType.CONVEYOR, direction: Direction.RIGHT, rotate: 'clockwise' }, // Curved
        { position: { x: 5, y: 7 }, type: TileType.CONVEYOR, direction: Direction.DOWN, rotate: 'clockwise' }, // Curved
        { position: { x: 6, y: 7 }, type: TileType.CONVEYOR, direction: Direction.DOWN },
        { position: { x: 7, y: 7 }, type: TileType.CONVEYOR, direction: Direction.UP, rotate: 'clockwise' }, // Curved
        { position: { x: 8, y: 7 }, type: TileType.CONVEYOR, direction: Direction.RIGHT, rotate: 'clockwise' }, // Curved
        ...
        { position: { x: 1, y: 10 }, type: TileType.CONVEYOR, direction: Direction.RIGHT, rotate: 'counterclockwise' }, // Curved
        ...
        { position: { x: 6, y: 10 }, type: TileType.CONVEYOR, direction: Direction.DOWN, rotate: 'counterclockwise' }, // Curved
        { position: { x: 7, y: 10 }, type: TileType.CONVEYOR, direction: Direction.LEFT, rotate: 'counterclockwise' }, // Curved turning up
        ...
        { position: { x: 11, y: 10 }, type: TileType.CONVEYOR, direction: Direction.LEFT, rotate: 'clockwise' }, // Curved
    ...
    walls: [
        ...
        { position: { x: 10, y: 8 }, sides: [Direction.RIGHT] },
