...
import { CourseDefinition, BoardDefinition, TileElement, LaserElement } from './boardDefinitions';
import { Direction, TileType } from '../types';

// Legacy Board Definitions from boardConfig.js

// Risky Exchange variations
export const RISKY_EXCHANGE_CLAUDE: CourseDefinition = {
...
export const RISKY_EXCHANGE_GEMINI: CourseDefinition = {
