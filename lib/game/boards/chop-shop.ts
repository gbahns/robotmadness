...
export const CHOP_SHOP_BOARD: BoardDefinition = {
    ...
    tiles: [
        ...
        { position: { x: 5, y: 2 }, type: TileType.EXPRESS_CONVEYOR, direction: Direction.LEFT, entries: [Direction.UP] },
        ...
        { position: { x: 9, y: 1 }, type: TileType.CONVEYOR, direction: Direction.DOWN, entries: [Direction.RIGHT] },
        ...
        { position: { x: 1, y: 6 }, type: TileType.CONVEYOR, direction: Direction.DOWN, entries: [Direction.LEFT] },
        ...
        { position: { x: 6, y: 5 }, type: TileType.CONVEYOR, direction: Direction.DOWN, entries: [Direction.RIGHT] },
        { position: { x: 2, y: 9 }, type: TileType.OPTION },
        { position: { x: 3, y: 2 }, type: TileType.EXPRESS_CONVEYOR, direction: Direction.UP, entries: [Direction.DOWN, Direction.RIGHT] },
    ],
