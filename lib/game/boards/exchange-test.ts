...
export const EXCHANGE_FACTORY_FLOOR_TEST: BoardDefinition = {
    ...
    tiles: [
        { position: { x: 0, y: 0 }, entries: [Direction.DOWN], type: TileType.CONVEYOR, direction: Direction.RIGHT },
        { position: { x: 1, y: 0 }, entries: [Direction.LEFT], type: TileType.CONVEYOR, direction: Direction.DOWN },
        { position: { x: 1, y: 1 }, entries: [Direction.UP], type: TileType.CONVEYOR, direction: Direction.LEFT },
        { position: { x: 0, y: 1 }, entries: [Direction.RIGHT], type: TileType.CONVEYOR, direction: Direction.UP },
        { position: { x: 2, y: 0 }, entries: [Direction.RIGHT], type: TileType.CONVEYOR, direction: Direction.DOWN },
        { position: { x: 3, y: 0 }, entries: [Direction.DOWN], type: TileType.CONVEYOR, direction: Direction.LEFT },
        { position: { x: 3, y: 1 }, entries: [Direction.LEFT], type: TileType.CONVEYOR, direction: Direction.UP },
        { position: { x: 2, y: 1 }, entries: [Direction.UP], type: TileType.CONVEYOR, direction: Direction.RIGHT },
        ...
        { position: { x: 8, y: 7 }, entries: [Direction.DOWN], type: TileType.CONVEYOR, direction: Direction.RIGHT },
