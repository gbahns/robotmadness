  ...
  io.on('connection', (socket) => {
    ...
    socket.on('start-game', (roomCode) => {
      ...
      gameState.board = {
        ...
        startingPositions: [
          { position: { x: 1, y: 10 }, direction: 0 },  // UP
          { position: { x: 3, y: 10 }, direction: 0 },  // UP
          { position: { x: 5, y: 10 }, direction: 0 },  // UP
          { position: { x: 7, y: 10 }, direction: 0 },  // UP
          { position: { x: 9, y: 10 }, direction: 0 },  // UP
          { position: { x: 11, y: 10 }, direction: 0 }, // UP
          { position: { x: 2, y: 10 }, direction: 0 },  // UP (backup)
          { position: { x: 10, y: 10 }, direction: 0 }, // UP (backup)
        ],
      };
